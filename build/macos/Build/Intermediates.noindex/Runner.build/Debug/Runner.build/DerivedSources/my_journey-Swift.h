...
#ifndef MY_JOURNEY_SWIFT_H
#define MY_JOURNEY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="my_journey",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10my_journey11AppDelegate")
...
SWIFT_CLASS("_TtC10my_journey17MainFlutterWindow")
